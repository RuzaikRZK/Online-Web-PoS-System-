...
<div class="col-md-5" style="margin-left: 300px;border-color: aliceblue;">
    <div class="form-area" >  
        ...
        <br style="clear:both">
					...
					<div class="form-group">
						<input type="text" class="form-control" id="email" name="email" placeholder="Email" required style="width: 362px;">
					</div>
					<div class="form-group">
					...
					<label>
						<img src="icons/track_icon&48.png">
						<input type="submit"  id="submit" name="submit"  required style="background-color:silver; " value="Add Supplier">
			...
			<?php
							...
							if(isset($_POST['submit'])){
								...
								$sql="INSERT INTO add_new_supplier (supplier_id,company_name,email,phone_number) VALUES ('Null','".$_POST["name"]."','".$_POST["email"]."','".$_POST["mobile"]."')";
			...
			?>
    			...
    			<div style="margin-left:-250px;font-size: 20px;margin-top:-380px;background-color:salmon;width: 210px;border-radius: 5px;color: aliceblue;border: solid;border-color: transparent;">
    	<a href="supplier_details.php"><label style="color: aliceblue;">Supplier Details <img src="icons/business_user.png"></label> </a>
    		</div>
    		...
    		<div style="margin-left:-250px;background-color: sandybrown;width: 210px;border-radius: 5px;color: aliceblue;">
    				...
    				<?php
						$result = mysql_query("select count(*) FROM add_new_supplier");
				$row = mysql_fetch_array($result);

				$total = $row[0];
					?>
    			
    				<label style="font-size: 20px;">Total Suppliers</label>
    				<img src="icons/user12.png">
