  ...
  $(document).ready(function() {
    $("#datepicker").datepicker();
    		...
    		<?php
							...
							$result = mysql_query("select COUNT(*)  item_name,price,discount,cash,invoice_number,quantity,selling_date,net_amount from sales_log where selling_date='$dates'");
				$row = mysql_fetch_array($result);

				$total2 = $row[0]/2.5;
							
				
				$sentency_severity=$total2;		
    	...
    	<img src="http://chart.apis.google.com/chart?chs=240x100&amp;cht=gm&amp;chco=555555,FAFA05|FF0000&amp;chd=t:<?php  echo $sentency_severity; ?>" width="250" height="110" alt="Sentence Severity" style="margin-bottom: 100px;" />
    		<label style="margin-left: -50px;"><?php echo $total2.'%'; ?></label>
    		<label style="color: red;"><?php  if($total2>50){
