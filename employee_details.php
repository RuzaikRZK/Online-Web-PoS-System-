...
<div class="col-md-5" style="margin-left: 300px;border-color: aliceblue;">
    <div class="form-area" >  
        ...
        <br style="clear:both">
                   ...
                   <?php
						...
						if(isset($_POST['search'])){
							...
							$query="select * from add_employee where national_id='$val'";
							$q=mysql_query($query);
                   ...
                   <div class="form-group">
					<label style="font-size: 15px;">Employee Id<input type="text" class="form-control" id="sid" value="<?php echo $empid; ?>" name="empid"></label>
					</div>	
                    
    				<div class="form-group">
						<label style="font-size: 15px;">Name<input type="text" class="form-control" id="name" name="name" value="<?php echo $name; ?>"></label>
					</div>
					<div class="form-group">
					<label style="font-size: 15px;">National Id<input type="text" class="form-control" id="email" name="nic" value="<?php echo $nic; ?>" style="width: 190px;"></label>
					</div>
					<div class="form-group">
					<label style="font-size: 15px;">Age<input type="text" class="form-control" id="mobile" value="<?php echo $age; ?>" name="age"></label>
					</div>
         					
         			<div class="form-group">
					<label style="font-size: 15px;">Email<input type="text" class="form-control" id="mobile" value="<?php echo $email; ?>" name="email"></label>
					</div>
					...
					<label style="font-size: 15px;">Mobile<input type="text" class="form-control" id="mobile" value="<?php echo $mobile; ?>" name="mobile"></label>
          			...
          			<input type="text" name="val" placeholder="Enter NIC Number" style="font-size: 15px;height: 35px;border-radius: 4px;color: red;border: solid;border-color: tomato;width: 210px;"/><br/><br/>
				...
				if(isset($_POST['delete'])){
						...
						$de="DELETE FROM add_employee WHERE employee_id='$c'";
						mysql_query($de);
		...
		$up="UPDATE add_employee SET name='$name',national_id='$nic',age='$age',email='$email',contact_number='$mobile'   WHERE employee_id='$emp'";
