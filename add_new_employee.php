...
<div class="col-md-5" style="margin-left: 300px;border-color: aliceblue;">
    <div class="form-area" >  
        ...
        <br style="clear:both">
					...
					<div class="form-group">
						<input type="text" class="form-control" id="email" name="nic" placeholder="NIC Number" required style="width: 362px;">
					</div>
					<div class="form-group">
						<input type="text" class="form-control" id="mobile" name="age" placeholder="Age" required>
					</div>
					<div class="form-group">
					...
					<label>
						<img src="icons/business_user.png">
						<input type="submit"  id="submit" name="submit"  required style="background-color:silver; " value="Add Employee">
			...
			<?php
							...
							if(isset($_POST['submit'])){
								...
								$sql="INSERT INTO add_employee (employee_id,name,national_id,age,email,contact_number) VALUES ('Null','".$_POST["name"]."','".$_POST["nic"]."','".$_POST["age"]."','".$_POST["email"]."','".$_POST['mobile']."')";
			...
			?>
    			...
    			<div style="margin-left:-250px;font-size: 20px;margin-top:-460px;background-color:salmon;width: 210px;border-radius: 5px;color: aliceblue;border: solid;border-color: transparent;">
    	<a href="employee_details.php"><label style="color: aliceblue;">Employee Details<img src="icons/business_user.png"></label> </a>
    		</div>
    		...
    		<div style="margin-left:-250px;background-color: sandybrown;width: 210px;border-radius: 5px;color: aliceblue;">
    				...
    				<?php
						$result = mysql_query("select count(*) FROM add_employee");
