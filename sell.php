    ...
    <div class="form-area" >  
        ...
        <br style="clear:both">
                    ...
                    <?php
						...
						if(isset($_POST['search'])){
							...
							$query="select item_name,selling_price from add_new_item where item_name='$val'";
							$q=mysql_query($query);
		...
		?>
    				...
    				<div class="form-group">
						<label style="font-size: 15px;">Item Name<input type="text" class="form-control" id="name" name="name" value="<?php echo $name; ?>"></label>
					</div>
					...
					<div class="form-group">
					<label style="font-size: 15px;">price<input type="text" class="form-control" id="email" name="price" value="<?php echo $price; ?>" style="width: 190px;"></label>
					</div>
					<div class="form-group">
					<label style="font-size: 15px;">Discount<input type="text" class="form-control" id="mobile" value="" name="discount"></label>
					</div>
        			
        			<div class="form-group">
					<label style="font-size: 15px;">Cash<input type="text" class="form-control" id="mobile" value="<?php  ?>" name="cash"></label>
					</div>
         					
          			<div class="form-group">
					<label style="font-size: 15px;">Ivoice Id<input type="text" class="form-control" id="sid" value="<?php  ?>" name="inid"></label>
					</div>	
        			
        					
          			<div class="form-group">
					<label style="font-size: 15px;">Quantity<input type="text" class="form-control" id="qu" name="qu" value="" ></label>
					</div>	
        			
        					
          			<div class="form-group">
					<label style="font-size: 15px;">Selling Date<input type="date" class="form-control" id="sid" value="<?php  ?>" name="sd"></label>
					</div>	
        			
        					
          			<div class="form-group">
					<label style="font-size: 15px;">Net Amount<input type="text" class="form-control" id="sid" value="<?php  ?>" name="na"></label>
					</div>	
          			...
          			<input type="text" name="val" placeholder="Enter Item Name" style="font-size: 15px;height: 35px;border-radius: 4px;color: red;border: solid;border-color: tomato;width: 210px;"/><br/><br/>
          				...
          				<button  style="font-size: 10px;"type="submit" name="add">Sell<img src="icons/sale.png"></button>
      				...
      				<?php
					if(isset($_POST['add'])){
        					$sql =mysql_query("INSERT INTO sales_log (sales_log_id,item_name,price,discount,cash,invoice_number,quantity,selling_date,net_amount)
       VALUES('NUll','".$_POST['name']."','".$_POST['price']."','".$_POST['discount']."','".$_POST['cash']."','".$_POST['inid']."','".$_POST['qu']."','".$_POST['sd']."','".$_POST['na']."')");
