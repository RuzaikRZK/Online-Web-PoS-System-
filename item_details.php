...
<div class="col-md-5" style="margin-left: 300px;border-color: aliceblue;">
    <div class="form-area" >  
        ...
        <br style="clear:both">
                   ...
                   <?php
						...
						if(isset($_POST['search'])){
							...
							$query="select item_id,item_name,category,cost_price,selling_price,quantity from add_new_item where item_name='$val'";
							$q=mysql_query($query);
                   ...
                   <div class="form-group">
					<label style="font-size: 15px;">Item Id<input type="text" class="form-control" id="sid" value="<?php echo $iid; ?>" name="iid"></label>
					</div>	
                    
    				<div class="form-group">
						<label style="font-size: 15px;">Item Name<input type="text" class="form-control" id="name" name="iname" value="<?php echo $iname; ?>"></label>
					</div>
					<div class="form-group">
					<label style="font-size: 15px;">Category<input type="text" class="form-control" id="email" name="category" value="<?php echo $category; ?>" style="width: 190px;"></label>
					</div>
					<div class="form-group">
					<label style="font-size: 15px;">Cost Pricce<input type="number" class="form-control" id="mobile" value="<?php echo $cp; ?>" name="cp"></label>
					</div>
        					
        			<div class="form-group">
					<label style="font-size: 15px;">Selling Price<input type="number" class="form-control" id="mobile" value="<?php echo $sp; ?>" name="sp"></label>
					</div>
        					
        					<div class="form-group">
					<label style="font-size: 15px;">Quantity<input type="number" class="form-control" id="mobile" value="<?php echo $qu; ?>" name="qu"></label>
					</div>
				...
				if(isset($_POST['delete'])){
						...
						$de="DELETE FROM add_new_item WHERE item_id='$c'";
						mysql_query($de);
    		 ...
    		 <button type="submit" name="delete"  style="font-size: 13px;margin-top:20px;">Delete Item<img src="icons/recycle-full.png"></button><br/>
		...
		$up="UPDATE add_new_item SET item_name='$iname', category='$category',cost_price='$cp',selling_price='$sp',quantity='$qu'  WHERE item_id='$c'";
 			  ...
 			  <button type="submit" name="update"  style="font-size: 13px;margin-top:20px;">Update Item<img src="icons/reload.png">
